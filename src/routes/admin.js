...
const {
  ...
  getDetailedServerInformation,
} = require("../controllers/adminControllers/get data/getServerInfo");
const {
  adminGetAllUsers,
  adminGetUser,
} = require("../controllers/adminControllers/get data/getUsers");
...
Router.get("/admin/:userId/serverinfo/v2", authentication, authorization, getDetailedServerInformation)
